...
Formats the current buffer according to the jsfmt tool." t nil)

(autoload 'jsfmt-save-ast "jsfmt" "\
Formats the current buffer according to the jsfmt ast tool." t nil)
