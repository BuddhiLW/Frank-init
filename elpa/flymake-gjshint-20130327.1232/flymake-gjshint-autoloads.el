...

;;;### (autoloads nil "flymake-gjshint" "flymake-gjshint.el" (0 0
;;;;;;  0 0))
...
Fix many of the glslint errors in current buffer by fixjsstyle." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "flymake-gjshint" '("flymake-gjshint:")))
