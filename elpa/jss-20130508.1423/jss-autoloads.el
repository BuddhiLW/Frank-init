...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jss-browser-webkit" '("define-jss-webkit-notification-handler" "jss-" "make-jss-webkit-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jss-debugger" '("define-jss-debugger-step-function" "jss-" "with-frame-at-point")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jss-deferred" '("appendf" "jss-deferred" "make-jss-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jss-io-pretty-printers" '("define-jss-io-cleaner" "jss-io-")))
