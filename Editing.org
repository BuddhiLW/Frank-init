...
* Rainbow-mode
  ...
  #+end_src
    ...
    #+RESULTS:
    | outshine-mode | auto-complete-mode | indent-guide-mode | evil-smartparens-mode | smartparens-mode | rainbow-delimiters-mode | fira-code-mode | prettify-symbols-mode |
