...
declare function anonymous(client?: string, version?: string): Promise<GrammarlyAuthContext>;
...
declare function applyDelta(text: string, change: Delta): string;
...
declare class SocketClient {
    ...
    private _setStatus;
    private UA;
    constructor(id: string, _getToken: () => Promise<string> | string, _onConnection?: () => void, _onMessage?: (message: Response) => void, ua?: string, additionalHeaders?: Record<string, string>);
    dispose(): void;
