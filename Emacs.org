...
#+RESULTS:
| global-emojify-mode | x-wm-set-size-hint | tramp-register-archive-file-name-handler | magit-maybe-define-global-key-bindings | table--make-cell-map |
...
#+RESULTS:
| rainbow-delimiters-mode | fira-code-mode | prettify-symbols-mode | text-mode-hook-identify |
** Nyan Cat Mode
#+begin_src emacs-lisp
